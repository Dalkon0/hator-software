...
<img src="https://hator.gg/img/logo.svg" alt="HATOR" width="120" />

# HATOR Software

**UI-концепт програми керування ігровою периферією**
...
### Клавіатура
- Візуальний превью клавіатури з RGB-анімацією в реальному часі
...
### Глобальне підсвічування
- Синхронізація RGB на всіх пристроях
...
### Система
- 4 теми оформлення (Dark, HATOR, Pink, Neon)
...
> *(додай скріншоти до папки `/screenshots` і вони з'являться тут)*
...
├── splash.html     # Сплеш-екран (резерв)
